    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(
                    db_index=True, help_text='Логин пользователя',
                    max_length=150, unique=True,
                    verbose_name='Има пользователя ')),
                ('email', models.EmailField(
                    db_index=True, help_text='email пользователя',
                    max_length=254, unique=True,
                    verbose_name='Адрес электронной почты')),
                ('first_name', models.CharField(
                    default=' ', help_text='Имя пользователя', max_length=150,
                    verbose_name='Имя')),
                ('last_name', models.CharField(
                    default=' ', help_text='Фамилия пользователя',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=('author', 'user'), name='unique_author_user'),
        ),
        migrations.AddConstraint(
            model_name='user',
            constraint=models.UniqueConstraint(
